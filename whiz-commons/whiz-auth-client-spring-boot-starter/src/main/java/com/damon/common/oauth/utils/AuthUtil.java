package com.damon.common.oauth.utils;

import com.damon.common.constant.CommonConstant;
import com.damon.common.constant.SecurityConstants;
import com.damon.common.context.LoginUserContextHolder;
import com.damon.common.entity.SysUser;
import com.damon.common.oauth.token.CustomWebAuthenticationDetails;
import com.damon.common.utils.SpringUtil;
...
public class AuthUtil {
    ...
    public static SysUser checkAccessToken(String accessTokenValue) {
        ...
        if (accessToken == null || accessToken.getValue() == null) {
            throw new InvalidTokenException("accessToken为空: " + accessTokenValue);
        } else if (accessToken.isExpired()) {
            tokenStore.removeAccessToken(accessToken);
            throw new InvalidTokenException("accessToken: " + accessTokenValue + " 已过期");
        }
        OAuth2Authentication result = tokenStore.readAuthentication(accessToken);
        if (result == null) {
            throw new InvalidTokenException("非法的accessToken: " + accessTokenValue);
        }
