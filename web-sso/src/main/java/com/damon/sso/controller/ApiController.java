package com.damon.sso.controller;
...
public class ApiController {
    ...
    @Value("${whiz.sso.client-id:}")
    private String clientId;

    @Value("${whiz.sso.client-secret:}")
    private String clientSecret;

    @Value("${whiz.sso.redirect-uri:}")
    private String redirectUri;

    @Value("${whiz.sso.access-token-uri:}")
    private String accessTokenUri;

    @Value("${whiz.sso.user-info-uri:}")
